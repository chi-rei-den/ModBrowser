...
namespace Chireiden.ModBrowser.Data.Migrations
{
    ...
    [Migration("20200309074912_AddLocalizerPackage")]
    partial class AddLocalizerPackage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chireiden.ModBrowser.Models.LocalizerPackage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("CreateTimeStamp")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Chireiden.ModBrowser.Models.Mod", b =>
                {
                    ...
                    b.Property<string>("ModReferences")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Chireiden.ModBrowser.Models.LocalizerPackage", b =>
                {
                    b.HasOne("Chireiden.ModBrowser.Models.Mod", "Mod")
                        .WithMany()
                        .HasForeignKey("ModName");

                    b.HasOne("Chireiden.ModBrowser.Models.ApplicationUser", "Uploader")
                        .WithMany()
